...
const VerifiedDownlines = ({ open, setOpen, downlines }) => {
                  ...
                  <div className="mt-3 sm:mt-0 sm:ml-4 sm:mr-4 w-full">
                    ...
                    <div className="mt-6 w-full">
                      <p className="text-sm text-gray-500 dialog--subtitle">
                        {downlines.map((agent) => (
                          <div className="rounded-xl py-4 px-5 bg-green-300 flex mb-2">
                            <div className="text-black">{agent.firstname} {agent.lastname}</div>
                          </div>
                        ))}
                      </p>
                    </div>
...
export default VerifiedDownlines;