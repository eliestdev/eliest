...
import Downline from '../views/downline/index'
        ...
        <div>
            <div className="header-bg" style={{ backgroundImage: `url(${Wave})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
                <div className="flex justify-between py-8 px-12 header-bg">
                    ...
                    <div>
                        <div className="transaction-header">Downlines</div>
                        <div className="transaction-text pt-4">Monitor Agent downline activities</div>
                    </div>
