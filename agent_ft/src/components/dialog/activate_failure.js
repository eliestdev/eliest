...
export default function ActivateFailure({ visible }) {
                            ...
                            <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <div className="sm:flex sm:items-center">
                                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-center">
                                        ...
                                        <img src={Warning} className="mb-4 mt-12 content-center icon-center mx-auto" />
                                        <Dialog.Title as="h3" className="text-lg leading-6 font-medium">
                                            You cant activate account
                                        </Dialog.Title>
                                        <div className="mt-6">
                                            <p className="text-sm text-gray-500 dialog--subtitle">
                                                You cannot activate this account, you need a minimum of 1000 to be in the account
                                            </p>
                                        </div>
                                    </div>
                                </div>
